...
public class App {
    ...
    private static void updataData () throws IOException {
        ...
        while (data != null){
            ...
            if (updateNum == entryCounts){
                ...
                if (isUpdate) {
                     ...
                     if (isExist){
                        System.err.println("Data buku sudah ada di database, proses updata dibatalkan, silahkan delete data yang bersangkutan!!");
    ...
    private static void deleteData() throws IOException{
        ...
        // looping untuk membaca tiap data barus dan skip data yang akan didelete.
        ...
        while (data != null) {
            ...
            StringTokenizer st = new StringTokenizer(data,",");
            // tmapilkan data yang ingin dihapus
