...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // merubah komponen dari String itu tidak bisa.. kenapa?
        ...
        // 2. Stirng yang berada di string pool itu akan reusable, memorynya lebih efisien
        // 3. membuat string dengan method baru, maka dia akan ditaruh di memory lain bukan di string pool
